Developed a temperature measurement system using an Arduino microcontroller. The system reads the temperature every minute for 24 hours and logs the data onto an SD card.
